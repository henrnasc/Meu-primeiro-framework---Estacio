    ...
    return (
        <div className='styles.container'>
            ...
            <main className={styles.main}>
                <h1 className='text-center text-black'>Dados do Livro</h1>
                <div className='container'>
                    <form onSubmit={incluir}>
                        <div className='form-group'>
                            <label htmlFor='titulo' typeof="text" className='text-black'>Título</label><br/>
                            <input name='titulo' className="form-control" onChange={(e) => setTitulo(e.target.value)} required></input><br/>
                        </div>

                        <div className='form-group'>
                            <label htmlFor='resumo' className='text-black'>Resumo</label><br/>
                            <textarea name='resumo' className="form-control" onChange={(e) => setResumo(e.target.value)}></textarea><br/>
                        </div>

                        <div className='form-group'>
                            <label htmlFor='editora' className='text-black'>Editora</label><br/>
                        ...
                        <div className='form-group'>
                            <label htmlFor='autores' className='text-black'>Autores (1 por linha)</label><br/>
